...
public class InfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = (TextInputEditText) v1.findViewById(R.id.ed_otp);
        contact = (TextInputEditText) v1.findViewById(R.id.ed_otp1);
        type = (TextInputEditText) v1.findViewById(R.id.ed_otp2);
    ...
    private void updateData(String name, String contact, String type) {
        db.collection("Vendors")
                .document(idUpdate)
                .update("name", name, "contactDetails", contact, "type", type)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
