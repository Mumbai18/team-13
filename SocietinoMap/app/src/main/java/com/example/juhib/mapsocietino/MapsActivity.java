...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        ImageButton btnMall = (ImageButton) findViewById(R.id.btnMall);
        ...
        ImageButton btnPharmacy = (ImageButton) findViewById(R.id.btnPharmacy);
        ...
        btnPolice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(MapsActivity.this,"Nearby Bus_Station", Toast.LENGTH_LONG).show();
            }
        });
        ImageButton btnGym = (ImageButton) findViewById(R.id.btnGym);
        btnGym.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(MapsActivity.this,"Nearby Gym", Toast.LENGTH_LONG).show();
            }
        });
